...
public class Philosopher extends BaseThread
{
	...
	public void think()
	{
		...
		{
			System.out.println("Philosopher.think():");
			DiningPhilosophers.reportException(e);
			System.exit(1);
		}
	...
	public synchronized void run()
	{
		...
		for(int i = 0; i < DiningPhilosophers.DINING_STEPS; i++)
		{
			...
			// *** Task-6 put the peppar methods
			DiningPhilosophers.soMonitor.pickUpPeppar(getTID());
			
			eat();
			
			DiningPhilosophers.soMonitor.putDownPeppar(getTID());
